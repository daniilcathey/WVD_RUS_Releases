...
1. **Скачайте** `WVD_Russifier.exe` из [последнего релиза](https://github.com/daniilcathey/WVD_RUS_Releases/releases/latest)
2. **Запустите** — лаунчер автоматически найдёт установленную игру
3. Нажмите **«Применить переводы»** и дождитесь завершения

Все переводы, шрифты и словари уже встроены в лаунчер. Дополнительные файлы скачивать не нужно.

> Если игра установлена в нестандартную папку, лаунчер предложит указать путь вручную.
...
Для ручного обновления: скачайте новый `WVD_Russifier.exe` из [релизов](https://github.com/daniilcathey/WVD_RUS_Releases/releases/latest) и запустите.
